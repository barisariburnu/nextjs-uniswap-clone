...
const style = {
    ...
    currencySelectorIcon: `flex item-center`,
    ...
    return (
        <div className={style.wrapper}>
            <div className={style.content}>
                ...
                <div className={style.transferPropContainer}>
                    <input type="text" className={style.transferPropInput} placeholder="0x..." onChange={(e) => handleChange(e, 'addressTo')} />
                    <div className={style.currencySelector}></div>
                </div>
                <div className={style.confirmButton} onClick={(e) => handleSubmit(e)}>Confirm</div>
            </div>
