    ...
    return (
        <div className={style.wrapper}>
            <div className={style.headerLogo}>
                <Image src={uniswapLogo} alt="uniswap" width={40} height={40} />
            </div>
            <div className={style.nav}>
                <div className={style.navItemsContainer}>
                    <div onClick={() => { setSelectedNav('swap'); }}
                        className={`${style.navItem} ${selectedNav === 'swap' && style.activateNavItem}`}>Swap
                    </div>
                    <div onClick={() => { setSelectedNav('pool'); }}
                        className={`${style.navItem} ${selectedNav === 'pool' && style.activateNavItem}`}>Pool
                    </div>
                    <div onClick={() => { setSelectedNav('vote'); }}
                        className={`${style.navItem} ${selectedNav === 'vote' && style.activateNavItem}`}>Pool
                    </div>
            ...
            <div className={style.buttonsContainer}>
                ...
                <div className={`${style.button} ${style.buttonPadding}`}>
                    <div className={`${style.buttonIconContainer} mx-2`}><HiOutlineDotsVertical /></div>
                </div>
            </div>
        </div >
    )
